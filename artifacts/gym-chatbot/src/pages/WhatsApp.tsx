...
const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    testPayload: {
      ...
      checkin_time: new Date().toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit", hour12: false }),
      membership_plan: "1 Month",
      status: "active",
    },
  },
  ...
  },
  {
    ...
    testPayload: {
      ...
      name: "Test Member",
      phone: "919999999999",
      plan_title: "Muscle Gain Program",
      assigned_date: new Date().toISOString().split("T")[0],
    },
  },
  {
